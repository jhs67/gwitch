...
import OriginUrl from "@renderer/assets/cloud.svg";
import TagUrl from "@renderer/assets/tag.svg";
import ActiveBadgeUrl from "@renderer/assets/active.svg";
import SubmoduleUrl from "@renderer/assets/submodule.svg";
import {
  setOriginClosed,
  setTagsClosed,
  setClientMode,
        ...
        <div className={classes.branches}>
          ...
          {refs
            ...
            .map((r) => (
              ...
              >
                <img src={BranchUrl} className={classes.refIcon} />
                <div className={classes.localBranch}>{r.name}</div>
                {r.refName === head ? (
                  <img src={ActiveBadgeUrl} className={classes.activeBadge} />
                ) : null}
              </div>
            ))}
        </div>
          ...
          {[...origins.entries()].map(([origin, refs]) => (
            <div className={classes.remoteSection} key={origin}>
              ...
              >
                ...
                <img src={OriginUrl} className={classes.originIcon} />
              ...
              {originClosed[origin]
                ...
                : refs.map((ref) => (
                    ...
                    >
                      <img src={BranchUrl} className={classes.remoteRefIcon} />
              ...
              : refs
                  ...
                  .map((r) => (
                    <div
                      ...
                      onClick={() => clickBranch(r.hash)}
                    >
                      <img src={TagUrl} className={classes.tagIcon} />
          ...
          <div className={classes.submodules}>
            ...
            {submodulesClosed
              ...
              : submodules.map((r) => (
                  ...
                  >
                    <img src={SubmoduleUrl} className={classes.submoduleIcon} />
